...
<template>
    <section id="home" class="flex items-center bg-lightBlack lg:py-0 overflow-hidden">
        <div class="px-32 mx-auto h-full">
            <div class="flex flex-col md:flex-row px-32 mx-auto h-full pt-8">
                <div class="flex-1 flex flex-col items-center lg:items-start">
                    ...
                    <button type="" class="btn btn-md bg-lightGreen hover:bg-lightDarkGreen hover:text-lightBeige md:btn-lg transition-all">
                        Push me!
                    </button>
                </div>
